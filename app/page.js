...
>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16">
          <div>
            ...
            <p className="mt-8 text-2×l md:text-4×l font-black text-white leading-relaxed drop-shadow-2×l">
            ...
            <p className="mt-6 text-2×l md:text-4×l font-black text-white leading-relaxed drop-shadow-2×l">
...
>
  ...
  <h2 className="text-3xl sm:text-4xl md:text-6xl font-black tracking-tight leading-none px-4">
    INFRASTRUCTURE EXPERIENCE
      ...
      <p className="mt-8 text-black font-extrabold text-3xl max-w-4xl mx-auto leading-relaxed">
